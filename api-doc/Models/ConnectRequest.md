...
| **jdbc\_url** | **String** | Legacy Spark JDBC driver connection url | [optional] [default to null] |
...
| **is\_sql\_endpoint** | **Boolean** | This is using legacy name. Sql Endpoint is now Sql Warehouse. The field should be the same as is_sql_warehouse. | [optional] [default to null] |
