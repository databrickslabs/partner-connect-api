...
|----------------------|-------|--------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|api_version           |string |yes     |2.0.5                                                                                                                                                                                                                                         |The partner api version supported by the partner. Format major.minor.patch                                                                                                                                                                    |
...
|P800|TestConnection     |Test connection api returns valid result after testing a PC provisioned connection.                                                               |Yes                                                                     |TestConnectonTests|
